...
exports.seed = function(knex, Promise) {
  ...
  return knex('author_info').del()
    .then(function () {
      // Inserts seed entries
      return knex('author_info').insert([
        {
          first:'Alex',
          last:'Martelli',
        ...
        },
        {
          ...
          image:'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/anna_ravenscroft.jpg'
        ...
        },
        {
          ...
          image:'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/steve_holden.jpg'
